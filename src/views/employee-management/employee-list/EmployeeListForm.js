...
function EmployeeListForm(props) {
  let { userName, userNameChange, genderData, selectGender, selectGenderChange,
    ...
    editClick, delClick,detailclick } = props;
  return (
    <div className='mt-4'>
                ...
                <table className='emp-list-table'>
                  <thead>
                    <tr>
                      ...
                      <th className='text-center' width={80} colSpan={3}>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                        ...
                        <tr key={index}>
                          ...
                          <td style={{ border: "1px solid" , textAlign:"center"}}>
                            ...
                            <td style={{ border: "1px solid" , textAlign:"center"}}>
                              <div className="user-before">
                                <CImg
                                  src="/image/Detail-Component-inactive.jpg"
                                  onClick={() => {
                                    detailclick(data.id);
                                  }}
                                  style={{
                                ...
                                <CImg
                                  className="user-after"
                                  src="/image/Detail-Component-active.jpg"
                                  onClick={() => {
                                   detailclick(data.id);
                                  }}
                                  style={{
